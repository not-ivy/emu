    ...
    <div className="p-4 md:px-20 text-hr-f-high grid grid-cols-7 grid-flow-row gap-x-4 md:gap-x-10 gap-y-4 md:gap-y-10">
      ...
      <main className="col-span-5 md:col-span-3">
        ...
        <div className="flex justify-around items-center mt-4 mx-auto">
          <HiArrowLeft />
          <input className="bg-hr-b-high text-hr-f-high caret-hr-f-high outline-none rounded-md p-4 text-center" placeholder='1'></input>
          <HiArrowRight />
        </div>
      </main>
      <div className="col-span-2 bg-hr-b-high rounded-md h-1/4 p-4 hidden md:block">
        <h3 className="text-xl font-semibold mb-10">Latest News</h3>
        <div className="flex flex-col">
          <div className="grid grid-cols-4 h-20">
            <div className="hidden md:block bg-hr-b-med rounded-md col-span-1 mr-4"></div>
            <div className="col-span-3 flex flex-col justify-between">
              <div className="h-7 rounded-lg bg-hr-b-med w-full"></div>
              <div className="h-4 rounded-lg bg-hr-b-med w-3/4"></div>
              <div className="h-4 rounded-lg bg-hr-b-med w-1/3"></div>
            </div>
          </div>
        </div>
      </div>
